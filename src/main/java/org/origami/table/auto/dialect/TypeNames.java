...
public final class TypeNames {
     ...
     */
    public String getByTypeCode(final int typeCode, Integer length, Integer precision, Integer scale) {
     ...
     */
    public String getByClassType(Class<?> clazz, Integer length, Integer precision, Integer scale) {
    ...
    private String getString(Integer length, Integer precision, Integer scale, DateType dateType) {
        if (length == null) {
